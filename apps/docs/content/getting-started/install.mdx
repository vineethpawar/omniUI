...
| `@plyxui/vscode` | You're shipping a VS Code webview extension and want plyxui to auto-theme to the IDE. | runtime |
...
**Three platform targets:** web (React + DOM), React Native (Metro picks `.native.tsx`), and **VS Code webview extensions** (via [`@plyxui/vscode`](/docs/getting-started/vscode/) — auto-themes to the user's active IDE colors).
