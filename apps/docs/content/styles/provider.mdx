...
- Reads `localStorage["omniui-theme-mode"]` for a previously chosen mode.
...
The provider also adds an `omniui-electron` class to `document.body` so you can pad the top of your shell to account for the title-bar zone.
